...
public class AlphaBetaClient7 extends GameClient {
	...
	private int alphabetaRec(Board b, int depth, int alpha, int beta,
		...
		// forward pruning
		Position threateningPieceAt = b.getPieceInMyHalf(p.getOpponent());
		List<Ply> plies = null;
		if (threateningPieceAt != null) {
	...
	public String getClientDescription() {
		return "AlphaBeta v7. Uses iterative Deepening, TT, TT-based Move Ordering, optimistic Forward Pruning, "
